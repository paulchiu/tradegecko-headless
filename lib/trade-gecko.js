 ...
 * @returns {Object[]}
 */
exports.getResources = async function (browserPage, params, requestOptions = resourcePagingOptions) {
    let {resource, resultLimit, fields} = params;
    ...
    do {
        ...
        logger(`Processed ${resources.length} of ${resultLimit} results, ${resultPercent.toFixed(2)}% complete`, 'vv');
